...
public class CollegeDao {
    ...
    public College findByCollege(int cid){
        ...
        String sql="select cid,name,nnscore_line,nscore_line,score_line from college where cid=?";
    ...
    public College findByName(String name){
        final College college=new College();
        String sql="select cid,name,nnscore_line,nscore_line,score_line from college where name=?";
    ...
    public int insertCollege(College college) {
        String sql = "INSERT INTO college (cid,name,nnscore_line,nscore_line,score_line) VALUES (?,?,?,?,?)";
